...
class login:
     ...
     def loginfn(self):
        ...
        self.name = Label(self.frame,text='Enter User_Name: ',font=('Arial',18,'bold'))

        self.namee_text=StringVar()
        self.namee = Entry(self.frame,textvariable=self.namee_text,fg='gray',width=25,font=('Arial',16,'bold'))

        self.password1 = Label(self.frame,text='Enter Password : ', fg='Green',font=('Arial',18,'bold'))
        ...
        if self.flag !=0:
            self.buttonAdmin = Button(self.frame,text='Admin',fg='gray12',font=('Georgia',18,'bold'),cursor='hand2', command=self.adminbutton2)
        else:
            self.buttonAdmin = Button(self.frame,text='Admin',fg='gray12',font=('Georgia',18,'bold'),cursor='hand2', command=self.adminbutton)

        self.buttonStudent = Button(self.frame,text='Student',fg='gray12',font=('Georgia',18,'bold'),cursor='hand2', command=self.studentbutton)
	# placing
     ...
     def register(self):
         ...
         self.labelr = Label(self.frame,text='Register',font=('Georgia',32,'bold'))

         self.namer = Label(self.frame,text='Name : ',font=('Arial',14,'bold'))

         self.namere_text=StringVar()
         self.namere = Entry(self.frame,textvariable=self.namere_text,fg='gray')

         self.idr = Label(self.frame,text='Roll No. : ',font=('Arial',14,'bold'))

         self.rollno_text=StringVar()
         self.idre = Entry(self.frame,textvariable=self.rollno_text,fg='gray',width=25,font=('Arial',12,'bold'))

         self.passwordr1 = Label(self.frame,text='Create Password : ', fg='Green',font=('Arial',14,'bold'))
         ...
         self.passwordr2 = Label(self.frame,text='Reenter Password : ', fg='Green',font=('Arial',14,'bold'))
     ...
     def studentbutton(self):
        ...
        self.name = Label(self.frame,text='Enter Name: ',font=('Arial',18,'bold'))
        self.name.place(x=100,y=140,width=240,height=60)
